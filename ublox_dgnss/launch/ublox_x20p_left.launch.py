...
def generate_launch_description():
  ...
  namespace_arg = DeclareLaunchArgument(
    "namespace", default_value="sensing/gnss/left"
  )
  ...
  product_id_string_arg = DeclareLaunchArgument(
    "product_id", default_value=TextSubstitution(text="0x1ab")
  )  
  ...
  container1 = ComposableNodeContainer(
    name='ublox_dgnss_left_container',
    namespace='',
  ...
  container2 = ComposableNodeContainer(
    name='ublox_nav_sat_fix_hp_left_container',
    namespace='',
    package='rclcpp_components',
    executable='component_container_mt',
    arguments=['--ros-args', '--log-level', LaunchConfiguration('log_level')],
